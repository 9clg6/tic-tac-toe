...
part 'create_matchmaking_request.use_case.provider.g.dart';

/// Provides [CreateMatchmakingRequestUseCase].
@riverpod
Future<CreateMatchmakingRequestUseCase> createMatchmakingRequestUseCase(
  Ref ref,
) async {
  final OnlineRepository repository = await ref.watch(
    onlineRepositoryProvider.future,
  );
  return CreateMatchmakingRequestUseCase(repository: repository);
}
