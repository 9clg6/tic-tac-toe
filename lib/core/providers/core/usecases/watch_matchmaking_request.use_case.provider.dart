...
part 'watch_matchmaking_request.use_case.provider.g.dart';

/// Provides [WatchMatchmakingRequestUseCase].
@riverpod
Future<WatchMatchmakingRequestUseCase> watchMatchmakingRequestUseCase(
  Ref ref,
) async {
  final OnlineRepository repository = await ref.watch(
    onlineRepositoryProvider.future,
  );
  return WatchMatchmakingRequestUseCase(repository: repository);
}
