...
import 'package:tictactoe/presentation/screens/game_lobby/game_lobby.view_model.dart';
...
/// Game lobby screen displayed before launching a match.
@RoutePage()
class GameLobbyScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final GameLobbyState state = ref.watch(gameLobbyViewModelProvider);
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          if (state.areAllPlayersReady) ...<Widget>[
            TextVariant(
              LocaleKeys.gameLobby_gameStartingSoon.tr(),
...
class PlayerSide extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final GameLobbyViewModel viewModel =
        ref.watch(gameLobbyViewModelProvider.notifier);
    final GameLobbyState state = ref.watch(gameLobbyViewModelProvider);
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              TextVariant(
                LocaleKeys.gameLobby_playerLabel
              ...
              const Gap(22),
              if (isPlayerReady)
                TextVariant(LocaleKeys.gameLobby_waitingOthers.tr()),
              const Gap(22),
              CustomButton(
                title: LocaleKeys.gameLobby_readyButton.tr(),
